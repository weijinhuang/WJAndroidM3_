...
public class PagerSnapHelperImpl2 extends PagerSnapHelper {
     int mCurrentLayoutMode = 2;//1,4,8,9,16

    public PagerSnapHelperImpl2(  int spanCount) {
         mCurrentLayoutMode = spanCount;
    }
    ...
    public void setSpanCount(int spanCount) {
        this.mCurrentLayoutMode = spanCount;
    }
...
//        LogUtils.d("forwardDirection:" + forwardDirection);
        if (forwardDirection && closestChildAfterCenter != null) {
//            LogUtils.d("closestChildAfterCenter:" + ((TextView) closestChildAfterCenter).getText());
...
//            LogUtils.d("closestChildBeforeCenter:" + ((TextView) closestChildBeforeCenter).getText());
            int position = layoutManager.getPosition(closestChildBeforeCenter);
            if (mCurrentLayoutMode != 1) {
                if (position % 4 != 0) {
                    if (forwardDirection) {
                        position += mCurrentLayoutMode;
                    } else {
                        position -= mCurrentLayoutMode;
                    }
                }
...
//        LogUtils.d("snapToPosition:" + snapToPosition);
...
//            LogUtils.d("findCenter:viewPosition:" + viewPosition);
            if (mCurrentLayoutMode == 1) {
                return closestChild;
            }
            int i = 0;
...
//        LogUtils.d("calculateDistanceToFinalSnap:" + out[0]);
        return out;
    }
