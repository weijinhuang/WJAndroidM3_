...
import static com.wj.basecomponent.view.LongSeViewPage2.ORIENTATION_HORIZONTAL;
import static com.wj.basecomponent.view.LongSeViewPage2.SCROLL_STATE_DRAGGING;
import static com.wj.basecomponent.view.LongSeViewPage2.SCROLL_STATE_IDLE;
import static com.wj.basecomponent.view.LongSeViewPage2.SCROLL_STATE_SETTLING;
...
//        }
    ...
    private LongSeViewPage2.OnPageChangeCallback mCallback;
    private final @NonNull
    LongSeViewPage2 mViewPager;
    private final @NonNull
...
//        private @AdapterState
     ...
     */
    int mAdapterState;
    private @LongSeViewPage2.ScrollState
    int mScrollState;
    ...
    ScrollEventAdapter(@NonNull LongSeViewPage2 viewPager) {
...
//        WJLog.Companion.d("onScrolled:mDispatchSelected=" + mDispatchSelected);
    ...
    void setOnPageChangeCallback(LongSeViewPage2.OnPageChangeCallback callback) {
        mCallback = callback;
    }
     ...
     * {@link LongSeViewPage2#endFakeDrag()} is called.
     */
     ...
     * the ViewPager is settling towards its {@link LongSeViewPage2#getCurrentItem() current item}, or
    ...
    private void dispatchStateChanged(@LongSeViewPage2.ScrollState int state) {
