...
public class PageTransformerAdapter extends LongSeViewPager.OnPageChangeCallback {
    private final RecyclerView.LayoutManager mLayoutManager;

    private LongSeViewPager.PageTransformer mPageTransformer;

    PageTransformerAdapter(RecyclerView.LayoutManager layoutManager) {
        mLayoutManager = layoutManager;
    }

    LongSeViewPager.PageTransformer getPageTransformer() {
     ...
     */
    void setPageTransformer(@Nullable LongSeViewPager.PageTransformer transformer) {
