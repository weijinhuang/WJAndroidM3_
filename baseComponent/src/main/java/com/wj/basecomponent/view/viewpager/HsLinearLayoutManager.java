 ...
 */
public class HsLinearLayoutManager extends RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {

    private static final String TAG = "HsLinearLayoutManager";
    ...
    HsViewBoundsCheck mVerticalBoundCheck = new HsViewBoundsCheck(new HsViewBoundsCheck.Callback() {
        @Override
        public View getChildAt(int index) {
            return HsLinearLayoutManager.this.getChildAt(index);
        }

        @Override
        public int getParentStart() {
            return HsLinearLayoutManager.this.getPaddingTop();
        }

        @Override
        public int getParentEnd() {
            return HsLinearLayoutManager.this.getHeight()
                    - HsLinearLayoutManager.this.getPaddingBottom();
        }
        ...
        public int getChildStart(View view) {
            ...
            return HsLinearLayoutManager.this.getDecoratedTop(view) - params.topMargin;
        }
        ...
        public int getChildEnd(View view) {
            final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                    view.getLayoutParams();
            return HsLinearLayoutManager.this.getDecoratedBottom(view) + params.bottomMargin;
        }
    });
    HsViewBoundsCheck mHorizontalBoundCheck = new HsViewBoundsCheck(new HsViewBoundsCheck.Callback() {
        @Override
        public View getChildAt(int index) {
            return HsLinearLayoutManager.this.getChildAt(index);
        }
        ...
        @Override
        public int getParentStart() {
            return HsLinearLayoutManager.this.getPaddingLeft();
        }

        @Override
        public int getParentEnd() {
            return HsLinearLayoutManager.this.getWidth() - HsLinearLayoutManager.this.getPaddingRight();
        }
        ...
        public int getChildStart(View view) {
            final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                    view.getLayoutParams();
            return HsLinearLayoutManager.this.getDecoratedLeft(view) - params.leftMargin;
        }
        ...
        public int getChildEnd(View view) {
            final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                    view.getLayoutParams();
            return HsLinearLayoutManager.this.getDecoratedRight(view) + params.rightMargin;
        }
    });
     ...
     * helps {@link HsLinearLayoutManager} make those decisions.
     */
    ...
    /**
     * Creates a vertical HsLinearLayoutManager
     *
     * @param context Current context, will be used to access resources.
     */
    public HsLinearLayoutManager(Context context) {
     ...
     */
    public HsLinearLayoutManager(Context context, int orientation,
     ...
     */
    public HsLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                 int defStyleRes) {
    ...
    /**
     * Sets the orientation of the layout. {@link HsLinearLayoutManager}
     ...
     *
     * <p>By default, {@link HsLinearLayoutManager} lays out 1 extra page
     ...
     * location, where 1) the extra content helps HsLinearLayoutManager know in advance when its
     ...
     * HsLinearLayoutManager} and stores the result in {@code extraLayoutSpace}. {@code
     ...
     *
     * <p>By default, {@code HsLinearLayoutManager} lays out 1 extra page of items while smooth
     ...
     * where 1) the extra content helps HsLinearLayoutManager know in advance when its target is
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler,
        ...
        for (int i = 0; i < scrapSize; i++) {
            ...
            try {
                Method isRemovedMethod = RecyclerView.ViewHolder.class.getDeclaredMethod("isRemoved");
                isRemovedMethod.setAccessible(true);
                isRemoved = (boolean) isRemovedMethod.invoke(isRemovedMethod);
            } catch (Exception e) {
                e.printStackTrace();
            }
            if (isRemoved) {
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return HsScrollbarHelper.computeScrollOffset(state, mOrientationHelper,
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return HsScrollbarHelper.computeScrollExtent(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return HsScrollbarHelper.computeScrollRange(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
                this, mSmoothScrollbarEnabled);
    }
     ...
     * <code>4</code> to this method for each inner RecyclerView's HsLinearLayoutManager will enable
     ...
     * independent from the rest of the {@link HsLinearLayoutManager}
    ...
    int fill(RecyclerView.Recycler recycler, LayoutState layoutState,
        ...
        while ((layoutState.mInfinite || remainingSpace > 0) && layoutState.hasMore(state)) {
            ...
            layoutState.mOffset += (layoutChunkResult.mConsumed) * 2 * layoutState.mLayoutDirection;
            /**
    ...
    View findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible,
                             boolean acceptPartiallyVisible) {
        ensureLayoutState();
        int preferredBoundsFlag = 0;
        int acceptableBoundsFlag = 0;
        if (completelyVisible) {
            preferredBoundsFlag = (HsViewBoundsCheck.FLAG_CVS_GT_PVS | HsViewBoundsCheck.FLAG_CVS_EQ_PVS
                    | HsViewBoundsCheck.FLAG_CVE_LT_PVE | HsViewBoundsCheck.FLAG_CVE_EQ_PVE);
        } else {
            preferredBoundsFlag = (HsViewBoundsCheck.FLAG_CVS_LT_PVE
                    | HsViewBoundsCheck.FLAG_CVE_GT_PVS);
        }
        if (acceptPartiallyVisible) {
            acceptableBoundsFlag = (HsViewBoundsCheck.FLAG_CVS_LT_PVE
                    | HsViewBoundsCheck.FLAG_CVE_GT_PVS);
        }
    ...
    View findOnePartiallyOrCompletelyInvisibleChild(int fromIndex, int toIndex) {
        ...
        if (mOrientationHelper.getDecoratedStart(getChildAt(fromIndex))
                < mOrientationHelper.getStartAfterPadding()) {
            preferredBoundsFlag = (HsViewBoundsCheck.FLAG_CVS_LT_PVS | HsViewBoundsCheck.FLAG_CVE_LT_PVE
                    | HsViewBoundsCheck.FLAG_CVE_GT_PVS);
            acceptableBoundsFlag = (HsViewBoundsCheck.FLAG_CVS_LT_PVS
                    | HsViewBoundsCheck.FLAG_CVE_LT_PVE);
        } else {
            preferredBoundsFlag = (HsViewBoundsCheck.FLAG_CVE_GT_PVE | HsViewBoundsCheck.FLAG_CVS_GT_PVS
                    | HsViewBoundsCheck.FLAG_CVS_LT_PVE);
            acceptableBoundsFlag = (HsViewBoundsCheck.FLAG_CVE_GT_PVE
                    | HsViewBoundsCheck.FLAG_CVS_GT_PVS);
        }
        return (mOrientation == HORIZONTAL) ? mHorizontalBoundCheck
                .findOneViewWithinBoundFlags(fromIndex, toIndex, preferredBoundsFlag,
                        acceptableBoundsFlag) : mVerticalBoundCheck
...
//                view = recycler.getViewForPosition(mCurrentPosition+1);
//            }else if(mCurrentPosition % 4 == 2){
//                view = recycler.getViewForPosition(mCurrentPosition-1);
//            }else{
