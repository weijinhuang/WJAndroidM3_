 ...
 */
public final class LongSeViewPage2 extends ViewGroup {
    ...
    public LongSeViewPage2(@NonNull Context context) {
        super(context);
        initialize(context, null);
    }

    public LongSeViewPage2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public LongSeViewPage2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//                    a.getInt(R.styleable.LongSeViewPage2_LongSeViewPage_orientation, ORIENTATION_HORIZONTAL));
    ...
    public void registerOnPageChangeCallback(@NonNull OnPageChangeCallback callback) {
        ...
        mExternalPageChangeCallbacks.addOnPageChangeCallback(new OnPageChangeCallback() {
            @Override
            public void onPageSelected(int position) {
            }
        });
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final AccessibilityViewCommand mActionPageForward =
                new AccessibilityViewCommand() {
                    ...
                    public boolean perform(@NonNull View view,
                        ...
                        LongSeViewPage2 viewPager = (LongSeViewPage2) view;
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
            ...
            if (ViewCompat.getImportantForAccessibility(LongSeViewPage2.this)
                    == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                ViewCompat.setImportantForAccessibility(LongSeViewPage2.this,
        ...
        public void onRvInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            event.setSource(LongSeViewPage2.this);
        ...
        void updatePageAccessibilityActions() {
            LongSeViewPage2 viewPager = LongSeViewPage2.this;
