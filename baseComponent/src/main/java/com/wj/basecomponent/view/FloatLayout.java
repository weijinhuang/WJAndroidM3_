...
public class FloatLayout extends FrameLayout {
    ...
    private void init() {
        viewDragHelper = ViewDragHelper.create(this, 1, new MyDragCallBack());
    }
...
//            if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
                dragView.layout(mChildWidth, mChildHeight, mChildWidth + mChildWidth, mChildHeight + mChildHeight);
//            }else{
//                dragView.layout(lastChildX, lastChildY, lastChildX + mChildWidth, lastChildY + mChildHeight);
//                WJLog.Companion.d("lastChildX:" + lastChildX + " lastChildY:" + lastChildY);
//            }
