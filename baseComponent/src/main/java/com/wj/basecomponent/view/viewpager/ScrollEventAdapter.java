...
import static com.wj.basecomponent.view.viewpager.LongSeViewPager.SCROLL_STATE_DRAGGING;
import static com.wj.basecomponent.view.viewpager.LongSeViewPager.SCROLL_STATE_IDLE;
import static com.wj.basecomponent.view.viewpager.LongSeViewPager.SCROLL_STATE_SETTLING;
...
//        }
    ...
    private LongSeViewPager.OnPageChangeCallback mCallback;
    private final @NonNull
    LongSeViewPager mViewPager;
    private final @NonNull
...
//        private @AdapterState
     ...
     */
    int mAdapterState;
    private @LongSeViewPager.ScrollState
    int mScrollState;
    ...
    ScrollEventAdapter(@NonNull LongSeViewPager viewPager) {
    ...
    /**
     * This method only deals with some cases of {@link  } transitions. The rest of
...
//        WJLog.Companion.d("onScrolled:mDispatchSelected=" + mDispatchSelected);
        if (mDispatchSelected) {
            ...
            WJLog.Companion.d(" scrollingForward = " + scrollingForward + " mScrollValues.mOffsetPx = " + mScrollValues.mOffsetPx + " mScrollValues.mPosition = " + mScrollValues.mPosition);
    ...
    private void updateScrollEventValues() {
        ...
        if (mLayoutManager instanceof LinearLayoutManager) {
            values.mPosition = ((LinearLayoutManager) mLayoutManager).findFirstVisibleItemPosition();
        } else if (mLayoutManager instanceof GridLayoutManager) {
            values.mPosition = ((GridLayoutManager) mLayoutManager).findFirstVisibleItemPosition();
        } else if (mLayoutManager instanceof StaggeredGridLayoutManager) {
            int[] firstVisibleItemPositions = ((StaggeredGridLayoutManager) mLayoutManager).findFirstVisibleItemPositions(null);
            values.mPosition = firstVisibleItemPositions[0];
        }
        ...
        if (mLayoutManager instanceof LinearLayoutManager) {
            ...
            isHorizontal = ((GridLayoutManager) mLayoutManager).getOrientation() == ORIENTATION_HORIZONTAL;
        }
        int start, sizePx;
        if (isHorizontal) {
    ...
    void setOnPageChangeCallback(LongSeViewPager.OnPageChangeCallback callback) {
        mCallback = callback;
    }
     ...
     * {@link LongSeViewPager#endFakeDrag()} is called.
     */
     ...
     * the ViewPager is settling towards its {@link LongSeViewPager#getCurrentItem() current item}, or
    ...
    private void dispatchStateChanged(@LongSeViewPager.ScrollState int state) {
    ...
    private final class ScrollEventValues {
        int mPosition;
        float mOffset;
        int mOffsetPx;
