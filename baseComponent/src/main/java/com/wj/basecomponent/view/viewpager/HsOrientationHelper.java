...
abstract public class HsOrientationHelper {
    ...
    private HsOrientationHelper(RecyclerView.LayoutManager layoutManager) {
    ...
    public static HsOrientationHelper createHsOrientationHelper(RecyclerView.LayoutManager layoutManager, int orientation) {
        switch(orientation) {
            case 0:
    ...
    public static HsOrientationHelper createHorizontalHelper(RecyclerView.LayoutManager layoutManager) {
        return new HsOrientationHelper(layoutManager) {
    ...
    public static HsOrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new HsOrientationHelper(layoutManager) {
            public int getEndAfterPadding() {
